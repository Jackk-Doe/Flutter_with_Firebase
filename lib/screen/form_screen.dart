...
class _FormScreenState extends State<FormScreen> {
  ...
  /// Prepare Firebase (Already called in main.dart)
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                    validator:
                        RequiredValidator(errorText: "First name require!"),
                ...
                TextFormField(
                    validator:
                        RequiredValidator(errorText: "Last name require!"),
                    // Assign Text form this TextFormField to Student's attribute
                ...
                TextFormField(
                    validator: RequiredValidator(errorText: "Score require!"),
